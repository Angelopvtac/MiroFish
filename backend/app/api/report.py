...
def generate_report():
    ...
    try:
        ...
        if not graph_id:
            return jsonify({
                "success": False,
                "error": "Missing graph ID. Please ensure a knowledge graph has been built."
            }), 400
...
def get_report_sections(report_id: str):
    ...
    The frontend can poll this endpoint to retrieve sections as they are generated,
...
def check_report_status(simulation_id: str):
    ...
    try:
        ...
        # Interview is only unlocked once the report is complete
...
def get_agent_log(report_id: str):
    ...
    - Section start, tool calls, LLM responses, section complete
...
def get_console_log(report_id: str):
    ...
    this returns plain-text console-style log output.

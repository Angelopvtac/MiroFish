...
class SimulationIPCClient:
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional; overridden by the platform field of each interview entry)
                - "twitter": Default to Twitter platform only
                - "reddit": Default to Reddit platform only
                - None: In dual-platform simulations, interview both platforms per agent
            timeout: Timeout in seconds

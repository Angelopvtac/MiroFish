...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        2. Generate an OASIS Agent Profile for each entity (optional LLM enhancement, parallel support)
        ...
        Args:
            ...
            document_text: Original document content (used for LLM context understanding)
            defined_entity_types: Predefined entity types (optional)
            use_llm_for_profiles: Whether to use LLM to generate detailed agent personas
        ...
        try:
            ...
            # Reddit has already been saved in real time during generation; save again to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: Run scripts remain in the backend/scripts/ directory and are not copied to the simulation directory.
            # When starting a simulation, simulation_runner will run the scripts from the scripts/ directory.

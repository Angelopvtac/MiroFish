...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        ...
        Always uses the configuration from the project root .env file (highest priority):
        - LLM_API_KEY: API key
    ...
    def _get_active_agents_for_round(
        ...
        # Compute activation probability for each Agent based on its config
        candidates = []
    ...
    async def run(self, max_rounds: int = None):
        ...
        for round_num in range(total_rounds):
            ...
            # Get Agents to activate for this round

    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Creates a new simulation instance and fetches the simulated world parameter template.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using context, automatically invokes tools to map entities and relations from the knowledge graph, initializes simulated individuals, and endows them with unique behaviors and memories based on reality seeds.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM intelligently configures world time speed, recommendation algorithms, active time windows, post frequency, event triggers, and other parameters for each agent based on the simulation requirements and reality seeds.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Based on the narrative direction, automatically generates initial activation events and trending topics to guide the simulated world's starting state.
          </p>
      ...
      <div class="step-card" :class="{ ‘active’: phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Simulation rounds config - only shown after config is generated and rounds are computed -->
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Experiential summary and behavioral style</span>
              </div>
              <div class="dimension-card">
...
// Log deduplication: track key info from the last log entry
...
watch(currentStage, (newStage) => {
  if (newStage === 'generating_profiles' || newStage === '生成Agent人设') {
    phase.value = 1
  } else if (newStage === 'generating_config' || newStage === '生成模拟配置') {
    phase.value = 2
  ...
  } else if (newStage === 'copying_scripts' || newStage === '准备模拟脚本') {
    phase.value = 2 // Still in config phase
  }
})

// Compute auto-generated round count from config (no hardcoded defaults)
const autoGeneratedRounds = computed(() => {
  if (!simulationConfig.value?.time_config) {
    return null // Return null while config is not yet generated
  }
...
// Compute total associated topic count across all profiles
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    // User custom round count - pass max_rounds parameter
    params.maxRounds = customMaxRounds.value
    addLog(`Starting simulation with custom rounds: ${customMaxRounds.value}`)
  } else {
    // User chose to keep auto-generated round count - do not pass max_rounds
...
const startPrepareSimulation = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      startPolling()
      // Start real-time profiles polling
...
/* Simulation rounds config style */

    ...
    <div class=”main-content”>
      ...
      <section class=”hero-section”>
        <div class=”hero-left”>
          ...
          <div class=”hero-desc”>
            <p>
              Even with just a paragraph of text, <span class=”highlight-bold”>MiroFish</span> can automatically generate a parallel world of up to <span class=”highlight-orange”>millions of Agents</span> based on the reality seeds within it. Inject variables from a god's-eye view, and search for <span class=”highlight-code”>”local optima”</span> in complex group interactions under dynamic environments.
            </p>
            <p class=”slogan-text”>
              Let the future rehearse in Agent swarms. Let decisions prevail after countless trials.<span class=”blinking-cursor”>_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction engine on standby. Upload one or more unstructured documents to initialize the simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & agent persona generation & environment agent injection of simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction goal in natural language (e.g., If Company X announces a product recall, what public sentiment trends will emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
